 ...
 * In the reduce callback function, set the current value a a key in the accumulator object, with the value set to whatever element is at the current index in the values array
 * 
 * 
 */
